                ...
                <div className=" flex flex-col items-center mt-[60px] mb-[260px]">
                    ...
                    <form action="" method="POST" id="form-login" >
                        ...
                        <div className="mb-[25px]">
                            ...
                            <input id="password" type="password" className="border py-3 w-[500px] pl-3 outline-none focus:outline-[#999999] require" onFocus={e=>{if(!e.target.value)setState({selector:'password', rules:['isFill',]})}}
                            onBlur={handleBlur}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div id="submit" onClick={e=>{setState({selector:'submit', rules:[]})}} className="flex rounded border w-32 h-14 text-white bg-black hover:bg-blue-600 hover:cursor-pointer ease-in duration-100 transition-colors "><span className=" m-auto">Đăng nhập</span></div>
                        </div>
                    </form>
