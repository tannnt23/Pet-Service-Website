...
function CartNotification({ show, setShow }) {
    ...
    return (
        <div className='modal fixed inset-x-0 inset-y-0 flex'>
            ...
            <div className='product_list bg-white z-[1] px-[30px] py-[20px] w-[350px] h-full absolute right-0 animate-Slideinright'>
                <button
                ...
                <div className='product_pay-check-cart mt-[25px]'>
                    <Link to='/ViewCart' className='bg-[#4c4c4c] text-[15px] text-white px-[18px] font-semibold py-[10px] rounded-full mr-[12px] hover:opacity-80'>XEM GIỎ HÀNG</Link>
                    <button className='bg-[#3d51ac] text-[15px] text-white px-[18px] font-semibold py-[10px] rounded-full hover:opacity-80'>THANH TOÁN</button>
                </div>
            </div>
        </div>
    )
