...
function About() {
    return (
        <div className=" [word-spacing:0px]">
            ...
            <div id="aboutBanner" className="">
                <div className="animate-scaleY w-[100%] h-[400px] bg-gradient-[90deg] from-[#fff] from-0% via-[#142391] via-50% to-[#fff] to-100% sm:bg-gradient-to-b flex justify-center items-center ">
                <p className="w-[100%] text-center text-white  text-[60px]  font-mono [word-spacing:-8px] font-bold  animate-scaleX origin-left ">
            ...
            <div className="  flex flex-col items-center text-[#333333]">
                <div className="my-[20px] w-[880px] text-[20px]">
                    <p className="my-[30px] ">
