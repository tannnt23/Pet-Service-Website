        ...
        <div>
            <Header />
                ...
                <div className="flex flex-col items-center mt-[60px] mb-[260px]">
                    <div className="font-bold text-[34px] mb-[40px]">ĐĂNG KÝ</div>
                    <form 
                    action="" 
                    method="POST" 
                    id="form-1" 
                    ...
                    <div className="mb-3">Các trường được đánh dấu <span className="text-[#e80000] text-[18px] font-extrabold">*</span> là bắt buộc</div>
                        <div className="mb-[25px]">
                            ...
                            <label 
                            htmlFor="user"  
                            className="text-[18px] font-semibold">Tên đăng nhập<span className="text-[#e80000] font-extrabold">*</span>
                            </label><br />
                            <input 
                            id="user" 
                        ...
                        <div className="mb-[25px]">
                            ...
                            <label 
                            htmlFor="tel"  
                            className="text-[18px] font-semibold">Số điện thoại<span className="text-[#e80000] font-extrabold">*</span>
                            </label><br />
                            <input 
                            id="tel" 
                            type="text" 
                        ...
                        <div className="mb-[25px]">
                            ...
                            className="text-[18px] font-semibold">Nhập lại mật khẩu<span className="text-[#e80000] font-extrabold">*</span>
                            </label><br />
                            <input 
                            id="confirm-password"
