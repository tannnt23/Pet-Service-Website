        ...
        <header className="flex  text-white  justify-between  text-sm w-1220   ">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex items-center">
              <input
                id="search-input"
                className="w-[300px] hidden h-[100%] pl-[10px] bg-white border-[1px] border-[#142391] outline-0 rounded-l-[20px] border-r-0 origin-right text-black"
                type="text"
                placeholder="Search..."
              ></input>
            ...
            <button
              ...
              className="cart px-4 hover:bg-sky-700 relative"
            >
      ...
      <div className=" flex justify-center py-5 ">
        <div className="w-1220 ">
          <div className="flex justify-between   ">
            ...
            <Link
              to="/"
              className="p-1.5 self-center font-bold text-neutral-600 flex items-center hover:text-blue-600  relative  group  "
            >
              DỊCH VỤ
              <ul className=" hidden w-264 group-hover:block  z-10 absolute  top-full rounded-lg text-sm text-cyan-900 bg-slate-100 border border-solid border-[#273172] pt-2 ">
                <li className=" left-0  p-3 hover:text-blue-600 ">
                  {" "}
                  <HashLink smooth to="/#home4">THÚ Y TẠI NHÀ</HashLink>
                  
                </li>
                <li className=" left-0  p-3 hover:text-blue-600  ">
                  <HashLink smooth to="/#home5">TẮM - VỆ SINH TẠI NHÀ</HashLink>
                </li>
                <li className=" left-0  p-3 hover:text-blue-600  ">
                  <HashLink smooth to="/#home6">CẮT - TỈA LÔNG TẠI NHÀ</HashLink>
                </li>
                <li className=" left-0  p-3 hover:text-blue-600  ">
                  <HashLink smooth to="/#home7">COMBO</HashLink>
                </li>
              </ul>
